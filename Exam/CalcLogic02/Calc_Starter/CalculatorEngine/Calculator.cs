...
namespace Calculator
{
	...
	public class CalcEngine
	{
		...
		private static string versionInfo = "Calculator v2.0.1.1/2";
...
//-----------------------------------------------
		...
		public static string ePowerOfTwo ()
		{            
            if (stringAnswer != "")
            {
                double numHold = System.Convert.ToDouble(stringAnswer);
                stringAnswer = System.Convert.ToString(Math.Pow(numHold, 2));
            }
            return (stringAnswer);            
        }

        public static string eFactorial()
        {             
            if (stringAnswer != "")
            {
                double numHold = System.Convert.ToDouble(stringAnswer);
				int numCh = System.Convert.ToInt32(numHold);

                if (numHold != numCh || numHold < 0 )
				{
					stringAnswer = "Неверный ввод";
                }
				else if(numHold==0 || numHold == 1)
				{
					stringAnswer = "1";
                }
				else
				{
                    int res = 1;
					for (int i = 2;  i <= numHold; ++i)
					{
						res *= i;
					}
                    stringAnswer = Convert.ToString(res);
                }
        ...
        public static string eReciprocal()
        {
            if (stringAnswer != "")
            {
                double numHold = System.Convert.ToDouble(stringAnswer);
        ...
        public static string eSquareRoot()
        {
            if (stringAnswer != "")
            {
                double numHold = System.Convert.ToDouble(stringAnswer);
        ...
        public static string eXRoot()
        {
            if (stringAnswer != "")
            {
                double numHold = System.Convert.ToDouble(stringAnswer);
                stringAnswer = System.Convert.ToString(Math.Pow(numHold, 1.0/3));
            }
            return (stringAnswer);
        }
