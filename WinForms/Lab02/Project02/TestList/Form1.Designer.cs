namespace TestList
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            memberList.Size = new Size(188, 58);
            memberList.TabIndex = 0;
            // 
            // peopleList
            // 
            peopleList.FormattingEnabled = true;
            peopleList.Items.AddRange(new object[] { "Иванов Иван Иванович", "Петров Петр Петрович", "Сергеев Сергей Сергеевич", "Абрамов Абрам Абрамовичь", "Викторова Виктория Викторовна" });
            peopleList.Location = new Point(18, 152);
            peopleList.Name = "peopleList";
            peopleList.Size = new Size(188, 23);
            peopleList.TabIndex = 1;
            // 
            // buttonAdd
            // 
            buttonAdd.Location = new Point(262, 34);
            ...
            // buttonDelete
            // 
            buttonDelete.Location = new Point(262, 63);
            ...
            // buttonSort
            // 
            buttonSort.Location = new Point(262, 92);
            ...
            // button1
            // 
            button1.Location = new Point(234, 152);
